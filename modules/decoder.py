...
class AttnDecoder(nn.Module):
    ...
    def __init__(self, max_text_length,
        ...
        # initialize layers
        # prenet
        self.prenet = PreNet(frame_size, dropout=dropout)
        ...
        for i in range(self.decoder_gru_layers):
    ...
    def forward(self, input, attn_gru_hidden,
        ...
        Args:
            ...
            decoder_gru_hiddens: A list of Tensors of length decoder_gru_layers,
        ...
        dtp = torch.sum(
            encoder_outputs * a.unsqueeze(2).expand(
                batch_size, self.max_text_length, self.attn_gru_hidden_size
            ), 1
        )
